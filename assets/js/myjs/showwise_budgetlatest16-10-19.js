            ...
            success: function(data) {
                ...
                if (data != "") {
                    ...
                    var markup2 = '<tr>' +
                        ...
                        '<td  style="text-align:right;solid 2px ;border-right:solid 2px;border-bottom:solid 2px ;border-left: 2px ;"  id="perdayfotage1' + sr + '"><button id="unit_1"  class="btn btn-xs btn-primary episodicstaffbrakup" ><i class="fa fa-angle-double-down"></i></button>' + paybel + '</td>' +
                        '</tr>';
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th style="white-space:nowrap;text-align:right;padding:10px 10px;">Variance</th>' +
                    '</tr>' +
                    '</thead>' +
                    '<tbody>';
                ...
                if (data.length > 0) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (i == 0) {
                            ...
                            html += '<tr>' +
                                ...
                                '<td  style="text-align:center;" id="rate_' + data[i].id + '">' + data[i].Designation + '</td>' +
                                ...
                                '<td style="text-align:right;" id="total_' + data[i].id + '"></td>' +
                                '</tr>';
                        } else {
                            html += '<tr>' +
                    ...
                    html += '<tbody><tfoot>' +
                        '<tr>' +
                        '<td >Total</td>' +
                        '<td >' + episodic_staffcost + '</td>' +
                        '<td ></td>' +
                        '<td  style="text-align:right;" ></td>' +
                        '<td style="text-align:right;" ></td>' +
                        '<td style="text-align:right;padding:10px 10px;" >' + total + '</td>' +
                        '<td style="text-align:right;padding:10px 10px;">' + variance + '</td>' +
                        '</tr>' +
                        '</tfoot></table>';
