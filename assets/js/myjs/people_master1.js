        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th style="display:none;white-space:nowrap;text-align:left;padding:10px 10px;">officialworkinghour</th>' +
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td  id="officialworkinghour_' + data[i].id + '" style="display:none;">' + data[i].official_working_hour + '</td>' +
