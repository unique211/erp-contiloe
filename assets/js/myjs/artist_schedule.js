$(document).ready(function() {
    ...
    $(document).on("submit", "#scenedetails_form", function(e) {
        ...
        // var table = $('#scene_wise').DataTable();
        // table.destroy();

        if ($.fn.DataTable.isDataTable('#scene_wise')) {
            $('#scene_wise').DataTable().destroy();
        }
    ...
    //     }
    // });
    $('#scene_wise').on("click", "button", function() {
    ...
    $(document).on("submit", "#schedulesheet_form", function(e) {
        ...
        var table = $('#scheduledata').DataTable();
        table.destroy();
        ...
        if (dlt > 0) {
            ...
            $("#lblfromtime_" + save_update).text(shifttime);
            $("#lbltotime_" + save_update).text(shifttotime);
            $("#lblduration_" + save_update).val(duration);
            $("#lblremark" + save_update).val(remarks);
            ...
            markup = '<tr class="project_tab_add_row" id="tab3_' + row_id + '" >' +
                ...
                '<td id="fromshifttimedata_"><div class="input-group timepicker" > <input type="text" class="form-control" id="shiftfromtime_' + row_id + '"  placeholder="hh:mm:ss" value=' + shifttime + '> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable style="display:none;" id="lblfromtime_' + row_id + '">' + shifttime + ' </lable> </td>' +
                '<td id="fromshiftotimedata_"><div class="input-group timepicker" > <input type="text" class="form-control calltimeto" id="shifttotime_' + row_id + '" placeholder="hh:mm:ss" value=' + shifttotime + '> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lbltotime_' + row_id + '">' + shifttotime + ' </lable></td>' +
                '<td id="duration_"><div class="input-group timepicker" > <input type="text" class="form-control" id="duration_' + row_id + '" placeholder="hh:mm:ss" value=' + duration + '> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lblduration_' + row_id + '">' + duration + ' </lable></td>' +
                '<td   id="callremark" ><textarea  id="remarkdata_' + row_id + '">' + remarks + '</textarea><lable  style="display:none;" id="lblremark' + row_id + '">' + remarks + ' </lable></td>' +
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    markup = '<tr class="project_tab_add_row" id="tab3_' + row_id + '" >' +
                        ...
                        '<td id="fromshifttimedata_"><div class="input-group timepicker" > <input type="text" class="form-control" id="shiftfromtime_' + row_id + '" value=' + data[i].fromshift + ' > <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable style="display:none;" id="lblfromtime_' + row_id + '">' + data[i].fromshift + ' </lable></td>' +
                        '<td id="fromshiftotimedata_"><div class="input-group timepicker" > <input type="text" class="form-control calltimeto" id="shifttotime_' + row_id + '" value=' + data[i].toshift + ' > <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lbltotime_' + row_id + '">' + data[i].toshift + ' </lable></td>' +
                        '<td id="duration_"><div class="input-group timepicker" > <input type="text" class="form-control" id="duration_' + row_id + '" value=' + data[i].duration + ' > <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lblduration_' + row_id + '">' + data[i].duration + ' </lable></td>' +
                        '<td id="callremark"><textarea  id="remarkdata_' + row_id + '"    >' + data[i].remark + '</textarea><lable  style="display:none;" id="lblremark' + row_id + '">' + data[i].remark + ' </lable></td>' +
                        '<td><button  class="doc_edit_data1 btn btn-xs btn-primary"   id="' + row_id + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data1 btn btn-xs btn-danger"   id="tab3_' + row_id + '"  ><i class="fa fa-trash"></i></button>' +
                        '</tr>';
                    $("#callsheet").append(markup);
                ...
                for (i = 0; i < result.length; i++) {
                    ...
                    if (did != '') {
                        ...
                        if (r != 0) {
                            ...
                            if (flag == 1) {
                                ...
                                markup = '<tr class="project_tab_add_row" id="tab3_' + calldata + '" >' +
                                    ...
                                    '<td id="fromshifttimedata_"><div class="input-group timepicker" > <input type="text" class="form-control" id="shiftfromtime_' + calldata + '"  placeholder="hh:mm:ss"> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable style="display:none;" id="lblfromtime_' + calldata + '"></lable></td>' +
                                    '<td id="fromshiftotimedata_"><div class="input-group timepicker" > <input type="text" class="form-control calltimeto" id="shifttotime_' + calldata + '" placeholder="hh:mm:ss"> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lbltotime_' + calldata + '"> </lable></td>' +
                                    '<td id="duration_"><div class="input-group timepicker" > <input type="text" class="form-control" id="duration_' + calldata + '" placeholder="hh:mm:ss"> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lblduration_' + calldata + '"> </lable></td>' +
                                    '<td   id="callremark" ><textarea  id="remarkdata_' + calldata + '"   ></textarea><lable  style="display:none;" id="lblremark' + calldata + '"> </lable></td>' +
                                ...
                                $('#lblfromtime_' + sr).text(different[0] + ":" + different[1] + ":" + different[2]);


                                var shifttime_to = $('#shifttime_to').val();

                                $('#shifttotime_' + sr).val(shifttime_to);
                                $('#lbltotime_' + sr).text(shifttime_to);
                                /*  markup = '<tr>'+
                        ...
                        markup = '<tr class="project_tab_add_row" id="tab3_' + sr + '" >' +
                            ...
                            '<td id="fromshifttimedata_"><div class="input-group timepicker" > <input type="text" class="form-control" id="shiftfromtime_' + sr + '"  placeholder="hh:mm:ss"> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable style="display:none;" id="lblfromtime_' + sr + '"></lable></td>' +
                            '<td id="fromshiftotimedata_"><div class="input-group timepicker" > <input type="text" class="form-control calltimeto" id="shifttotime_' + sr + '" placeholder="hh:mm:ss"> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lbltotime_' + sr + '"> </lable></td>' +
                            '<td id="duration_"><div class="input-group timepicker" > <input type="text" class="form-control" id="duration_' + sr + '" placeholder="hh:mm:ss"> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span></div><lable  style="display:none;" id="lblduration_' + sr + '"> </lable></td>' +
                            '<td   id="callremark" ><textarea  id="remarkdata_' + sr + '"   ></textarea><lable  style="display:none;" id="lblremark' + sr + '"> </lable></td>' +
                        ...
                        $('#lblfromtime_' + sr).text(different[0] + ":" + different[1] + ":" + different[2]);
                        $('#lbltotime_' + sr).text(shifttimeto);
    ...
    $(document).on("blur", ".calltimeto", function(e) {
        ...
        $('#lblfromtime_' + id[1]).text(start);
        $('#lbltotime_' + id[1]).text(end);
        ...
        if (end != "") {
            ...
            if (hour > 0) {
                ...
                $('#lblduration_' + id[1]).text(hour + ":" + min + ":" + sec);
            } else {
                swal({
    ...
    function caltimedata() {
        ...
        for (var k = 0; k < l; k++) {
            ...
            $('#lblduration_' + row).text(hour + ":" + min + ":" + sec);
        }
    }
    ...
    /*------------click Event of  Export Buttton-----------------*/
    // $("#btnExport").click(function() {
    //     $("#scheduledata").table2excel({
    //         exclude: ".noExl",
