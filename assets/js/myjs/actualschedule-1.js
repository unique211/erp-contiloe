    ...
    success: function(data)
    {
        ...
        for(i=0; i<data.length; i++){
           sr=sr+1;
            ...
            '<td   id="tamount_"><input type="text" style="text-align: right;" id="amount'+sr+'" value='+tamt+' size="5%"></td>'+
...
amtdata(); 
    ...
    $(document).on("change",".suppliernm",function(e){
      ...
      // var  rate=$('#rate_'+id[1]).val();
       ...
       var  accountid= $(l1[sid]).find('td:eq(1)').html();
       var  subaccount= $(l1[sid]).find('td:eq(2)').html();
            ...
            //var data1=eval(data);
                ...
                if(data != ''){
                 ...
                 var qtyed= $('#qty_'+sid).val();
                    $('#amount'+sid).val(parseFloat(qtyed) * parseFloat(data[0].rate) )
                }else{
                   // $('#rate_'+sid).val('0');
                }
            amtdata();    
      ...
      //  if(save_update!=""){
       ...
       // }
        ...
        var html =  '<tr class="project_tab_add_row" id="'+row_id+'" >'+
                ...
                '<td  id="fotage_'+row_id+'">'+plannesfotage+'</td>'+
               ...
               // '<td  id="actualfotage_'+row_id+'"><input type="text" id="actualfotagedata_'+row_id+'" value='+actualfotage+' width="10%"></td>'+
                ...
                '<td  id="actualfotage_'+row_id+'">'+actualfotage+'</td>'+
...
//						}
   ...
   var markup = '<tr>'+
    ...
    '<td   id="narro_"><input type="text" id="narroation_'+sr+'" value='+narroation+' size="15%"></td>'+
    '<td   id="planamt_"><lable  id="planamount_'+sr+'" size="5%">'+0+'</lable></td>'+
    ...
    '<td   id="tamount_"><input type="text" style="text-align: right;" id="amount'+sr+'" value='+amunt+' size="10%"></td>'+
    '<td  id="treference_"><input type="text" id="refenceno'+sr+'" value='+reference+' size="10%"></td>'+
  //  '<td><button  class="doc_edit_data2 btn btn-xs btn-primary"   id="'+sr+'"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data2 btn btn-xs btn-danger"   id="'+sr+'"  ><i class="fa fa-trash"></i></button>'+
    '</tr>';
          ...
          //  $("#scenebody").html('');
            ...
            for(i=0; i<data.length; i++){
               ...
               // var dataarray = data[i].name.split(",");
                ...
                var html =  '<tr class="project_tab_add_row" id="'+row_id+'" >'+
                '<td  style="white-space: nowrap; text-align: left; padding: 10px;display:none;" >'+row_id+'</td>'+
                '<td style="white-space: nowrap; text-align: left; padding: 10px;" id="screenno_'+row_id+'">'+data[i].scenno+'</td>'+
                '<td style="white-space: nowrap; text-align: left; padding: 10px;" id="description_'+row_id+'">'+data[i].description+'</td>'+
                '<td style="white-space: nowrap; text-align: left; padding: 10px;" id="effect_'+row_id+'">'+data[i].effect+'</td>'+
                '<td style="white-space: nowrap; text-align: left; padding: 10px;" id="sublocation_'+row_id+'">'+data[i].sublocation+'</td>'+
                '<td  style="display:none;" id="artistname_'+row_id+'">'+data[i].charecterid+'</td>'+
                '<td style="white-space: nowrap; text-align: left; padding: 10px;"  id="charectername_'+row_id+'">'+data[i].charectername+'</td>'+
                '<td  style="white-space: nowrap; text-align: left; padding: 10px;" id="fotage_'+row_id+'">'+data[i].planfotage+'</td>'+
            ...
            // '<td style="white-space: nowrap; text-align: left; padding: 10px;"  id="actualfotage_'+row_id+'"><input type="text" id="actualfotagedata_'+row_id+'" value='+data[i].actualfotage+' width="10%"></td>'+
              ...
              '<td  id="actualfotage_'+row_id+'">'+data[i].actualfotage+'</td>'+
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(i=0; i<data.length; i++){
                    ...
                    '<td  id="callremark"><textarea  id="actualremarkdata_'+row_id+'"   size="10%" value='+data[i].remarks+'>'+data[i].remarks+'</textarea></td>'+
...
//						}
        ...
        for(i=0; i<data.length; i++){
            ...
            '<td   id="expenssubaccname_'+data[i].id+'">'+data[i].subaccname+'</td>'+
            '<td  id="narro_"><input type="text" id="narroation_'+sr+'" size="15%" value='+data[i].narration+' ></td>'+
            '<td   id="planamt_"><lable id="planamount_'+sr+'"  size="5%">'+data[i].plannedamt+'</lable></td>'+
            ...
            '<td      id="tamount_"><input type="text" style="text-align: right;" id="amount'+sr+'" value='+tamt+' size="10%"></td>'+
           '<td  id="treference_"><input type="text" id="refenceno'+sr+'" value='+data[i].referenceno+' size="10%"></td>'+
            //'<td><button  class="doc_edit_data2 btn btn-xs btn-primary"   id="'+sr+'"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data2 btn btn-xs btn-danger"   id="'+sr+'"  ><i class="fa fa-trash"></i></button>'+
            '</tr>';
...
var sr=0;
    ...
    for(var i=0;i<r;i++){
        ...
        if(paymentmode=='Cash'){
            caseamt=parseInt(caseamt)+parseInt(amt);
        }else{
            chequamt=parseInt(chequamt)+parseInt(amt);
        }
        planamt= parseInt(planamt)+parseInt(totalplan);
