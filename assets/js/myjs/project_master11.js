$(document).ready(function() {
    ...
    //for changes of file ---15-02-2020
    $(document).on('click', '#artist', function(e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            status = $(r1[i]).find('td:eq(14)').html();
            ...
            artistdata["proid"] = proid;
            artistdata["roleid"] = roleid;
            artistdata["persone"] = persone;
            artistdata["date"] = date;
            artistdata["ldate"] = ldate;
            artistdata["creditday"] = creditday;
            artistdata["rate"] = rate;
            artistdata["perunit"] = perunit;
            artistdata["overtime"] = overtime;
            artistdata["status"] = status;
            artistdata["type"] = type;
            artistdata["filename"] = filename;

            artistObj.push(artistdata);



        }
        // console.log('artist array' +parseFloat.json artistObj));
        artistObj = JSON.stringify(artistObj);
        console.log("artistdata" + artistObj);
        $.ajax({
            type: "POST",
            url: baseurl + "projectcontroller/save_settings",
            //  dataType: "JSON",
            async: false,
            data: {
                artistObj: artistObj,
    ...
    $(document).on('click', '#tab2', function(e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            productionstaff["proid"] = proid;
            productionstaff["roleid"] = roleid;
            productionstaff["persone"] = persone;
            productionstaff["date"] = date;
            productionstaff["leavingdate"] = ldate;
            productionstaff["creditday"] = creditday;
            productionstaff["rate"] = rate;
            productionstaff["perunit"] = perunit;
            productionstaff["overtime"] = overtime;
            productionstaff["status"] = statu;
            productionstaff["type"] = type;
            productionstaff["filename"] = filename;


            productiondata.push(productionstaff);
    ...
    $(document).on('click', '#tab3', function(e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            episodcidata = {};
            episodcidata["proid"] = proid;
            episodcidata["roleid"] = roleid;
            episodcidata["persone"] = persone;
            episodcidata["date"] = date;
            episodcidata["ldate"] = ldate;
            episodcidata["creditday"] = creditday;
            episodcidata["rate"] = rate;
            episodcidata["perunit"] = perunit;
            episodcidata["overtime"] = overtime;
            episodcidata["status"] = statu;
            episodcidata["type"] = type;
            episodcidata["filename"] = filename;

            episodicstaff.push(episodcidata);



        }
        episodicstaff = JSON.stringify(episodicstaff);
        $.ajax({
            type: "POST",
            url: baseurl + "projectcontroller/save_settings",
            dataType: "JSON",
    ...
    $(document).on('click', '#monthly_tab', function(e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            monthystaff["proid"] = proid;
            monthystaff["expensiveid"] = expensiveid;
            monthystaff["subacid"] = subacid;
            monthystaff["vendorname"] = vendorname;
            monthystaff["effecitivedate4"] = effecitivedate4;
            monthystaff["leavingdate4"] = leavingdate4;
            monthystaff["amount"] = amount;
            monthystaff["status"] = status;
            monthystaff["filename"] = filename;


            monthluydata.push(monthystaff);

        }
        monthluydata = JSON.stringify(monthluydata);
        console.log("artistdata" + monthluydata);
        $.ajax({
            type: "POST",
            url: baseurl + "projectcontroller/save_settings",
            dataType: "JSON",
    ...
    $(document).on('click', '#save', function(e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            documentinfo["description"] = description;
            documentinfo["filename"] = filename;
            documentinfo["proid"] = proid;

            documentdata.push(documentinfo);
        }
        documentdata = JSON.stringify(documentdata);
        console.log("artistdata" + documentdata);
        $.ajax({
            type: "POST",
            url: baseurl + "projectcontroller/save_settings",
            dataType: "JSON",
