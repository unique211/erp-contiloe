									...
									<div class="col-sm-12">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" form="showwisereport" class="form-control input-sm" id="noofepisode" name="noofepisode">
											</div><!-- /form-group -->
										</div>
										<div class="col-sm-4">
										</div>
														...
														<div class="table-responsive">
															<table id="budgetentry" class="table table-striped" style="width:100%" ;>
																<thead>
																	...
																	<tr>
																		<th colspan="11" style="text-align:center;background-color:#DCDCDC;font-size: 20px;color:#000000">Footage</th>
																	</tr>
																	<tr>
																		<th colspan="5" style="text-align:center;background-color:#1E90FF;color:#000000">Planned</th>
																		<th colspan="6" style="text-align:center;background-color:#32CD32;color:#000000">Acutal</th>
																	</tr>
																	<tr>
                    ...
                    <div class="row">
									<div class="form-group">
										...
										<table id="episodic" class="table table-" style="width:100%";>
											<thead >
												<tr>
													<th colspan="5" style="text-align:center;background-color:#DCDCDC;font-size: 20px;color:#000000" >Actual Expenses </th>
													...
													<div class="col-lg-12">
														...
														<div class="table-responsive">
															<table id="episodicstaffcost" class="table table-" style="width:100%" ;>
																<thead>
																	<tr>
																		<th colspan="4" style="text-align:center;background-color:#EE82EE;font-size: 15px;color:#000000">Episodic Staff Cost</th>
																	...
																	<tr>
																		<th style="border-left:solid 2px;"></th>
																		<th style="text-align:right;"> Monthly Budget</th>
																		<th style="text-align:right;"> Produced episode</th>
													...
													<div class="col-lg-12">
														...
														<div class="table-responsive">
															<table id="productionadmin" class="table table-" style="width:100%" ;>
																<thead>
																	<tr>
																		<th colspan="7" style="text-align:center;background-color:#EE82EE;font-size: 15px;color:#000000">Production/Admin Staff Cost</th>
																	...
																	<tr>
																		<th style="width:10%;border-left:solid 2px;"></th>
																		<th style="width:10%;text-align:right;"> Monthly Budget</th>
																		...
																		<th style="width:10%;text-align:right;">Actual</th>
