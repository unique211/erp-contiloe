            ...
            <div class="padding-md">
				...
				<div class="row formhideshow" id="documents">
									...
									<div class="col-sm-12" >
										...
										<select  form="charectermaster_form" class="form-control select2 input-sm project_name" id="project" name="project" required>
									...
									<div class="col-sm-12" >
										...
										<select  form="charectermaster_form" class="form-control select2 input-sm people" id="people" name="people" required>
														<option selected disabled >Select</option>
									...
									<div class="col-sm-12" >
										...
										<div class="col-lg-4" >
											<div class="form-group">
										<label class="control-label" id="person_char">Character*</label>
