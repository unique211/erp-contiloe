        ...
        <div id="main-container">
            ...
            <div class="padding-md">
                <div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<b><?php echo "Artist wise breackup Report"; ?></b>
				...
				<div class="row" id="documents">
									...
									<div class="col-sm-12" >
										<div class="col-sm-3" >
                                        <label class="control-label">For People Type*</label>
										</div>
										<div class="col-lg-3" >
											<div class="form-group">
									
										<select  form="showwisereport" class="form-control select2 input-sm people" id="peopletype" name="peopletype" required>
														<option selected disabled >Select</option>
								...
								<div class="row abc" >
									<div class="form-group">
										...
										<table id="expensebudget" class="table table-" style="width:100%";>
											<thead >
												<tr>
													<th colspan="7" style="text-align:center;background-color:#DCDCDC;font-size: 20px;color:#000000" >Attendance Report</th>

													<th colspan="4" style="text-align:center;background-color:#DCDCDC;font-size: 15px;color:#000000" class="grant_total"></th>
												</tr>
												<tr>
													<th style="width:10%;border-left:solid 2px;">Type / <BR> Invoice No.</th>
													<th style="width:10%;border-left:solid 2px;">Date</th>
													<th style="width:5%;border-left:solid 2px;"> Unit</th>
													<th style="width:15%;border-left:solid 2px;"> Location</th>
													<th style="width:10%;border-left:solid 2px;text-align:right;"> From</th>
													
													<th style="width:10%;border-left:solid 2px;text-align:right;">To</th>
													<th style="width:10%;border-left:solid 2px;text-align:right;">Duration</th>
													<th style="width:8%;border-left:solid 2px;text-align:right"> Rate</th>
													<th style="width:7%;border-left:solid 2px;text-align:right"> EH.Rate</th>
													<th style="width:10%;border-left:solid 2px;text-align:right;">Extra Hours</th>
													<th style="width:10%;border-left:solid 2px;text-align:right;">Amount</th>
...
<!-- last Table Add Here    -----------> 
    ...
    <!-- <script src="<?php echo base_url(); ?>assets/js/myjs/showwise_budget.js"></script> -->
	 <script src="<?php echo base_url(); ?>assets/js/myjs/artistwisereport.js"></script>
