						...
						<button type="submit" form="plannexpenses_form" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
									...
									<form id="expensive_form" name="expensive_form"></form>
										<div class="form-group">
											...
											<tr><th colspan="2" ><b>Cheque Plann Expenses: &nbsp;<lable style="text-align:right" id="totalcheque" ></lable></b></th><th colspan="2">Cash Plann Expenses:&nbsp;<lable style="text-align:right" id="totalcaseexpenses" ></lable> </th><th colspan="5">Plann Expenses:&nbsp;<lable style="text-align:right" id="totalexpenses" ></lable></th> </tr>
											<tr>
