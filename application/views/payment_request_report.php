				...
				<div class="row" id="documents">
									...
									<div class="col-sm-12"  id="from_date123"  >
										...
										<div class="col-lg-3" >
                                            ...
                                            <div class="input-group date doj" data-provide="datepicker">
												<input type="text"   form="showwisereport"  class="fromdate form-control input-sm placeholdesize datepicker "  id="fromdate" name="fromdate"  >
									...
									<div class="col-sm-12"  id="to_date123"  >
										...
										<div class="col-lg-3" >
                                            ...
                                            <div class="input-group date doj" data-provide="datepicker">
												<input type="text" form="showwisereport"  class="form-control input-sm placeholdesize datepicker todate"  id="todate" name="todate" >
												<div class="input-group-addon">
													<span class="fa fa-calender"></span>
												</div>
											</div>
						...
						<div class="col-lg-12" >
											...
											<button type="button" form="showwisereport" class="btn btn-sm btn-success btn-sm pull-right gen_btn">Generate</button>
											</div>
										...
										<table id="budgetentry" class="table table-striped" style="width:100%";>
											<thead >
												...
												<tr>
													...
													<th colspan="2" style="text-align:center;" id="reportfromdate" ><?= date('d/m/Y') ?> </th>
													<th colspan="2" style="text-align:center;" >To</th>
													<th colspan="2" style="text-align:center;" id="reporttodate" ><?= date('d/m/Y') ?></th>
...
<!-- last Table Add Here    -----------> 
								<div class="row abc" >
									<div class="form-group">
										...
										<div class="table-responsive">
										<table id="myTable" id="expensebudget" class="table table-striped" style="width:100%";>
											<thead >
												<tr>
													<th colspan="7" style="text-align:center;background-color:#DCDCDC;font-size: 20px;color:#000000" >Payment Request Report</th>

													<th colspan="3" style="text-align:center;background-color:#DCDCDC;font-size: 15px;color:#000000" class="grant_total"></th>
												</tr>
												<tr>
													<th style="width:10%;border-left:solid 2px;">Invoice No</th>
																										<th style="width:10%;border-left:solid 2px;">Month</th>

													<th style="width:15%;border-left:solid 2px;">Invoice Date</th>
													<th style="width:15%;border-left:solid 2px;"> Due Date</th>
													<th style="width:10%;border-left:solid 2px;text-align:left;">  Supplier-People Name </th>
													...
													<th style="width:10%;border-left:solid 2px;text-align:right;">Designation</th>
													<th style="width:10%;border-left:solid 2px;text-align:right;">Invoice Amount</th>
													<th style="width:10%;border-left:solid 2px;text-align:left;">Paid amount</th>
													<th style="width:10%;border-left:solid 2px;text-align:left;">Balance Amount</th>
													<!-- <th style="width:10%;text-align:right;border-right:solid 2px;">Amount</th> -->
												</tr>
											</thead >
											<tbody id="payment_req_body">
...
<!-- last Table Add Here    -----------> 
    ...
    <!-- <script src="<?php echo base_url(); ?>assets/js/myjs/showwise_budget.js"></script> -->
	 <script src="<?php echo base_url(); ?>assets/js/myjs/payment_req_report.js"></script>
...
function fnExcelReport() {
    ...
    $('#get_exxcel').attr('download', 'Payment Request Report.xls');
