    			...
    			<div class="modal-content">
				    ...
				    <div class="modal-body">
							...
							<form id="list_artist_form" name="list_artist_form"></form>
										...
										<select  form="list_artist_form" class="form-control input-sm select2 budget unit" id="unit" style="width:100%;" name="unit" >
													<option selected disabled >Select</option>
    			...
    			<div class="modal-content">
				    ...
				    <div class="modal-body">
							...
							<form id="list_Production_form" name="list_Production_form"></form>
										...
										<select  form="list_Production_form" class="form-control select2 input-sm budget unit" id="unit1" name="unit1" >
													<option selected disabled >Select</option>
													<option value="1" >Per Day</option>
													<option value="2" >Per Month</option>
													<option value="3" >Per Episode</option>
				    ...
				    <div class="modal-body">
							...
							<form id="list_Episodic_form" name="list_Episodic_form"></form>
										...
										<div class="col-sm-12" >
											...
											<div class="form-group">
										<label class="control-label">Per Unit</label>
										<select  form="list_Episodic_form" class="form-control select2 input-sm budget unit" id="unit2" name="unit2" style="width:100%;" >
													<option selected disabled >Select</option>
													<option value="1" >Per Day</option>
													<option value="2" >Per Month</option>
													<option value="3" >Per Episode</option>
							...
							<form id="monthlyexpenses" name="monthlyexpenses"></form>
										...
										<div class="col-sm-6" >
											<div class="form-group">
												...
												<input type="text" form="monthlyexpenses" class="form-control input-sm " id="vendorname" name="vendorname" style="text-align:right;"  placeholder="Vendor Name">
											</div><!-- /form-group -->
										</div>
										<div class="col-sm-6" >
											<div class="form-group">
						...
						<button type="submit" form="monthlyexpenses" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
									...
									<div class="col-sm-12" >
										...
										<div class="form-group">
											...
											<table id="tblmonthlyexpenses" class="table table-stripe">
											<thead>
											<tr>
