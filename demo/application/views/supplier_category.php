...
<?php include "includes/headerlink.php"; ?>    
  ...
  <body class="overflow-hidden"  >
        ...
        <div id="main-container">
            ...
            <div class="padding-md">
				...
				<div class="row formhideshow" id="documents">
									<form id="supplier_form" name="supplier_form"></form>
									<div class="col-sm-12" >
										<div class="col-sm-4" >
										</div>
										<div class="col-lg-4" >
										...
										<label class="control-label">Description*</label>
												<input type="text" form="supplier_form" class="form-control input-sm" id="description" name="description"  placeholder="Description" required  >
											</div>
										</div>
										<div class="col-sm-4" >
										</div>
						...
						<div class="col-lg-12" >
							<input type="hidden" id="save_update" value=""	/>
											...
											&nbsp;	&nbsp;	<button type="submit" form="supplier_form" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/suppilercategory.js"></script>
