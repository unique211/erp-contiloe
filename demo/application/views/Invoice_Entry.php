                                    ...
                                    <div class="tab-pane fade active in tab-pane" id="invoiceEntry">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date doj" data-provide="datepicker">
												        <input type="text" class="form-control input-sm placeholdesize datepicker" id="e_date" name="e_date" required >
                                        ...
                                        <div class="col-sm-12" >
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="input-group  doj"> 
												        <input type="text" class="form-control input-sm placeholdesize date1 datepicker s_date" id="s_date" name="s_date" required>
												        <div class="input-group-addon">
													        <span class="fa fa-calender"></span>
												        </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-12" >
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" form="invoice_form" name="s_no" id="s_no" class="form-control" placeholder="Supp. Invoice No" required/>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="input-group date doj" data-provide="datepicker">
												        <input type="text" class="form-control input-sm placeholdesize datepicker" id="invoicedate" name="invoicedate" required>
												        <div class="input-group-addon">
													        <span class="fa fa-calender"></span>
												        </div>
											        </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date doj" data-provide="datepicker">
												        <input type="text" class="form-control input-sm placeholdesize datepicker" id="d_date" name="d_date" required>
												        <div class="input-group-addon">
													        <span class="fa fa-calender"></span>
												        </div>
											        </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group episodic" style="display:none;">
                                                    ...
                                                    <input type="text" form="invoice_form" name="noofeposoic" id="noofeposoic" class="form-control episodicgross eposoidreq"  placeholder="No. of Episodes in the Month"/>
                                                </div><!-- /form-group -->
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group episodic" style="display:none;"  >
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea id="remarkdata" class="form-control input-sm placeholdesize datepicker"></textarea>
                                                </div><!-- /form-group -->
                                            </div>
                                           </div>
                                     ...
                                     <!--   <div class="col-sm-12" >
                                        ...
                                        <div class="col-sm-12" >
                                            <div class="col-sm-12 form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" class="form-control totalinvoice" name="" style="text-align:right;" value="0" id="grossamt" placeholder=""/>
                                                </div>
                                            </div>
                                        </div>
                                        <br> 
