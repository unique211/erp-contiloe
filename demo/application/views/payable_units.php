...
<?php include "includes/headerlink.php"; ?>    
  ...
  <body class="overflow-hidden"  >
        ...
        <div id="main-container">
            ...
            <div class="padding-md">
				...
				<div class="row formhideshow" id="documents">
									<form id="payable_form" name="payable_form"></form>
									<div class="col-sm-12" >
										<div class="col-sm-4" >
										...
										<input type="text" form="payable_form" class="form-control input-sm" id="name" name="name"  placeholder="Name" required  >
											</div><!-- /form-group -->
										</div>
										<div class="col-sm-4" >
										</div>
						...
						<div class="col-lg-12" >
							<input type="hidden" id="save_update" value=""	/>
											...
											&nbsp;	&nbsp;	<button type="submit" form="payable_form" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/payable_master.js"></script>
