...
<?php include "includes/headerlink.php"; ?>    
  ...
  <body class="overflow-hidden"  >
				...
				<div class="row formhideshow" id="documents">
									...
									<div class="col-sm-12" >
										...
										<label class="control-label">Name</label>
												<input type="text" form="peoplerole_form" class="form-control input-sm" id="name" name="name"  placeholder="name" required  >
											</div>
										</div>
										<div class="col-sm-4" >
										</div>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/expensesgroup.js"></script>
