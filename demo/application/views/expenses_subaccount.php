...
<?php include "includes/headerlink.php"; ?>    
  ...
  <body class="overflow-hidden"  >
        ...
        <div id="main-container">
            ...
            <div class="padding-md">
				...
				<div class="row formhideshow" id="documents">
									<form id="expensessubaccount" name="expensessubaccount"></form>
									<div class="col-sm-12" >
										<div class="col-sm-4" >
										</div>
										<div class="col-lg-4" >
										...
										<input type="text" form="expensessubaccount" class="form-control input-sm" id="name" name="name"  placeholder="Name" required  >	
											</div>
										</div>
										<div class="col-sm-4" >
										</div>
									...
									<div class="col-sm-12" >
										...
										<div class="col-lg-4" >
											<div class="form-group">
								<label class="control-label">Expenses Account*</label>
                                <select  form="expensessubaccount" class="form-control select2 input-sm expense_type" id="expensesaccount" name="expensesaccount" required>
						...
						<div class="col-lg-12" >
							<input type="hidden" id="save_update" value=""	/>
											...
											&nbsp;	&nbsp;	<button type="submit" form="expensessubaccount" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
    ...
    <script src="<?php echo base_url(); ?>assets/js/myjs/expenses_subaccount.js"></script>
