						...
						<input type="hidden" id="screen_row_id" value="0"	/>
							...
							<form id="charectermaster_form" name="charectermaster_form"></form>
								<div class="row formhideshow" id="scene_details">
									...
									<br>
		<div class="modal fade" id="scenewise_details">
						...
						<button type="submit" form="scenewise_form" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
									...
									<div class="form-group">
										...
										<table id="scenewise_table" class="table table-striped">
											<thead>
												<tr>
												<tr><th></th><th colspan="2">Planned Fotage: &nbsp;<lable style="text-align:right" id="plannedtotal" ></lable></th><th></th><th colspan="2">Actual Fotage: &nbsp;<lable style="text-align:right" id="Actualfotagetotal" ></lable></th><th></th></tr>
													<th>Scene No.</th>
									...
									<form id="peopleattend_form" name="peopleattend_form"></form>
										...
										<div class="col-sm-4" >
											<div class="form-group">
												...
												<select  form="peopleattend_form" class="form-control select2 input-sm people" id="people_type" name="people_type" required>
														<option selected disabled>select</option>
										...
										<div class="col-lg-4" >
											<div class="form-group">
												...
												<select  form="peopleattend_form" class="form-control select2 input-sm role" id="role" name="role" required>
														<option selected disabled>select</option>
										...
										<div class="col-sm-4" >
											<div class="form-group">
												...
												<select  form="peopleattend_form" class="form-control input-sm select2" id="people" name="people" required>
														<option selected disabled>select</option>
														<option value="1">role1</option>
														<option value="2">role2</option>
													</select>
									...
									<div class="table-responsive"> 
										<table id="peopleattand" class="table table-striped">
											...
											<thead>
												...
												<th style="display:none;">People Typeid</th>
													<th>People Type</th>
													<th style="display:none;">Characterid</th>
						...
						<input type="hidden" id="expensivesave_update" value=""	/>
							...
							<input type="hidden" id="workinghour" value=""	/>
								...
								<div style="margin-top:0px;border-bottom:2px solid;width:100%;">
									...
									<br>
		<div class="modal fade" id="Actual_expense1">
  			<div class="modal-dialog">
    			<div class="modal-content">
      				<div class="modal-header">
        				<button type="button" class="close" data-dismiss="modal" aria-hidden="true" >&times;</button>
									...
									<div class="col-sm-12" >
										...
										<div class="col-lg-4" >
											<div class="form-group">
												...
												<input type="number" form="actualexpe_form"  style="text-align:right"  class="form-control input-sm rate" id="rate" name="rate" placeholder="Rate" required>
											</div><!-- /form-group -->
										</div>
										<div class="col-sm-4" >
											<div class="form-group">
										...
										<input type="number" form="actualexpe_form" style="text-align:right"  class="form-control input-sm amount" id="amountdata" name="amount" placeholder="Amount" required>
											</div><!-- /form-group -->
										</div>
						...
						<button type="submit" form="actualexpe_form" class="btn btn-sm btn-success btn-sm pull-right">Save</button>
									...
									<div class="form-group">
										...
										<!--	<tr><th colspan="2">Planned Amount: &nbsp;<lable style="text-align:right" id="totalplanamt" ></lable></th><th width="20%">Actual Cheque Expenses: &nbsp;<lable style="text-align:right" id="totalcheque" ></lable> </th><th width="20%">Actual Cash Expenses: &nbsp;<lable style="text-align:right" id="totalcase" ></lable></th><th></th><th></th><th colspan="3">Actual Expenses: &nbsp;<lable style="text-align:right" id="totalactualexpenses" ></lable></th><th></th><th></th></tr>-->
											<tr><th colspan="2">Planned Amount: &nbsp;<lable style="text-align:right" id="totalplanamt" ></lable></th><th colspan="2">Actual Cheque Expenses: &nbsp;<lable style="text-align:right" id="totalcheque" ></lable> </th><th colspan="4">Actual Cash Expenses: &nbsp;<lable style="text-align:right" id="totalcase" ></lable></th><th colspan="3">Actual Expenses: &nbsp;<lable style="text-align:right" id="totalactualexpenses" ></lable></th></tr>
												<tr>
												<th style="display:none;">sr no</th>
												<th style="display:none;">Expense Accountid</th>
													<th style="display:none;">Expense Sub Accountid </th>
