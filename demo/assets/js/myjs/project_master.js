$(document).ready(function() {
    ...
    $(document).on("submit", "#list_Production_form", function(e) {
        ...
        if (save_update != "") {
            ...
            var html = '<tr class="project_tab_add_row" id="' + row_id + '" >' +
                ...
                '<td style="column-width:70px;"><button  class="doc_edit_data1 btn btn-xs btn-primary"   id="' + row_id + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data btn btn-xs btn-danger"   id="' + row_id + '"  ><i class="fa fa-trash"></i></button>' +
                '</tr>';
    ...
    $(document).on("submit", "#list_Episodic_form", function(e) {
        ...
        if (save_update != "") {
            ...
            var html = '<tr class="project_tab_add_row" id="' + row_id + '" >' +
                ...
                '<td style="column-width:70px;"><button  class="doc_edit_data2  btn btn-xs btn-primary"   id="' + row_id + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data3 btn btn-xs btn-danger"   id="' + row_id + '"  ><i class="fa fa-trash"></i></button>' +
                '</tr>';
    ...
    $(document).on("submit", "#monthlyexpenses", function(e) {
        ...
        if (save_update != "") {
            ...
            var html = '<tr class="project_tab_add_row" id="' + row_id + '" >' +
                ...
                '<td  id="amountdata_' + row_id + '">' + amountdata + '</td>' +
                // '<td  id="startdate_' + row_id + '">' + startdate + '</td>' +
                //'<td  id="enddate_' + row_id + '">' + enddate + '</td>' +
                '<td><button  class="doc_edit_data5 btn btn-sm btn-primary"   id="' + row_id + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data5 btn btn-sm btn-danger"   id="' + row_id + '"  ><i class="fa fa-trash"></i></button>' +
                '</tr>';
    ...
    $(document).on('click', '#monthly_tab', function(e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            //  var t = document.getElementById('project_tab3');
            expensiveid = $(r1[i]).find('td:eq(1)').html();
            subacid = $(r1[i]).find('td:eq(2)').html();
            vendorname = $(r1[i]).find('td:eq(5)').html();

            amount = $(r1[i]).find('td:eq(6)').html();
            // startdate= $(r1[i]).find('td:eq(5)').html();
            //enddate = $(r1[i]).find('td:eq(6)').html();


            /* var tdateAr = startdate.split('/');
             startdate = tdateAr[2] + '-' + tdateAr[1] + '-' + tdateAr[0];

             var tdateAr = enddate.split('/');
             enddate = tdateAr[2] + '-' + tdateAr[1] + '-' + tdateAr[0];*/
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    if (data[i].type == "artist") {
                        ...
                        var html = '<tr class="project_tab_add_row" id="' + row_id1 + '" >' +
                            ...
                            '<td><button  class="doc_edit_data2 btn btn-xs btn-primary"   id="' + row_id1 + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data btn btn-xs btn-danger"   id="' + row_id1 + '"  ><i class="fa fa-trash"></i></button>' +
                            '</tr>';
                        //$('#episidic').html('');
                        $("#project_tab3").append(html);
                        ...
                        var leaving = leving[2] + '/' + leving[1] + '/' + leving[0];
                        row_id2 = row_id2 + 1;
                        var html = '<tr class="project_tab_add_row" id="' + row_id2 + '" >' +
                            ...
                            '<td><button  class="doc_edit_data1 btn btn-xs btn-primary"   id="' + row_id2 + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data btn btn-xs btn-danger"   id="' + row_id2 + '"  ><i class="fa fa-trash"></i></button>' +
                            '</tr>';
                        //	$('#production').html('');
                        $("#project_tab2").append(html);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    /* var tdateAr = data[i].startdate.split('-');
                       var  startdate = tdateAr[2] + '/' + tdateAr[1] + '/' + tdateAr[0];

                         var leving = data[i].enddate.split('-');
                         var  enddate = leving[2] + '/' + leving[1] + '/' + leving[0];*/
                    ...
                    var html = '<tr class="project_tab_add_row" id="' + row_id + '" >' +
                        ...
                        '<td  id="amountdata_' + row_id + '">' + data[i].amount + '</td>' +
                        // '<td  id="startdate_' + row_id + '">' + startdate + '</td>' +
                        //'<td  id="enddate_' + row_id + '">' + enddate + '</td>' +
                        '<td><button  class="doc_edit_data5 btn btn-sm btn-primary"   id="' + row_id + '"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data5 btn btn-sm btn-danger"   id="' + row_id + '"  ><i class="fa fa-trash"></i></button>' +
                        '</tr>';
