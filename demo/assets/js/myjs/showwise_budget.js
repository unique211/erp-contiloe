$(document).ready(function () {
    ...
    $(document).on("submit", "#showwisereport", function (e) {
        ...
        var noofepisode = $('#noofepisode').val();
        var fdate = '';
        var tdate = '';
        var frommonthtext = $("#frommonth option:selected").text();
        var tomonthtext = $("#tomonth option:selected").text();
        if (fromyear > toyear) {
            ...
            success: function (data) {
                ...
                if (data != "") {
                    ...
                    markup = '<tr>' +
                        ...
                        '<td style=" text-align:right;border-top:solid 2px ;border-bottom:solid 2px ;" id="perdayfotage1' + sr + '">' + parseFloat(totalunit).toFixed(0) + '</td>' +
