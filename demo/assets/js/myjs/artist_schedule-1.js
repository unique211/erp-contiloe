...
$(document).on('click','.doc_edit_data1',function(e){
    ...
    // alert(peopletypeid+""+charecter+""+people+""+shifttime+""+shifttotime+""+duration+""+remark);
        ...
        $.ajax({
                ...
                success: function(data)
                {
                    ...
                    for(i=0; i<data.length; i++){
                        ...
                        '<td width="5%" id="peopletype_'+row_id+'">'+data[i].peopletypename+'</td>'+
                        '<td style="display:none;"  id="roleid_'+row_id+'">'+data[i].characterid+'</td>'+
                        '<td  id="rolename_'+row_id+'">'+data[i].charectername+'</td>'+
               ...
               //$(selecter).html(html);
                   ...
                   var sr=0;
                    ...
                    for(i=0; i<data.length; i++){
                      ...
                      // alert(tamt);
                       var markup='<tr class="project_tab_add_row" id="'+sr+'" >'+
                        ...
                        '<td width="30%" id="expessubaccname_'+sr+'">'+data[i].subaccount+'</td>'+
                        ...
                        '<td><button  class="doc_edit_data2 btn btn-xs btn-primary"   id="'+sr+'"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="plann_regional_delete_data2 btn btn-xs btn-danger"   id="'+sr+'"  ><i class="fa fa-trash"></i></button>'+
                        '</tr>';
  ...
  $(document).on('click','.closehideshow',function(){
    ...
    function show_master(){
        ...
        $.ajax({
                    ...
                    url  : baseurl+"settings/get_master_where",
                    async : false,
                    data : {table_name:'artist_schedule',
                            where:where,
                            },
                    dataType : 'json',
                    success : function(data){
          ...
          for(i=0; i<result.length; i++){
             ...
             for(var j=0;j<r;j++)
              {   
                  ...
                  var roleid = $(r1[j]).find('td:eq(3)').html();
                      //  alert("people"+peopleid+"result"+result[i].pid);
                        //alert("role"+roleid+"role_id"+result[i].role_id);
            ...
            //  alert(flag);
              ...
              {calldata=calldata+1;
                ...
                '<td  id="rolename_'+calldata+'">'+result[i].charectername+'</td>'+
                '<td style="display:none;"  id="peopleid_'+calldata+'">'+result[i].pid+'</td>'+
                '<td width="15%" id="peoplename_'+calldata+'">'+result[i].peoplename+'</td>'+// last changes
              ...
              '<td><button  class="doc_edit_data1 btn btn-xs btn-primary"   id="'+calldata+'"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data1 btn btn-xs btn-danger"   id="'+calldata+'"  ><i class="fa fa-trash"></i></button>'+
              '</tr>';
              $("#callsheet").append(markup);
		 ...
		 $('#shifttotime_'+sr).val(shifttime_to);
          ...
          else
          {
            ...
            markup = '<tr>'+
                ...
                '<td><button  class="doc_edit_data1 btn btn-xs btn-primary"   id="'+sr+'"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="regional_delete_data1 btn btn-xs btn-danger"   id="'+sr+'"  ><i class="fa fa-trash"></i></button>'+
                '</tr>';
                    $("#callsheet").append(markup);
                    var shifttime= $('#shifttime').val();
...
var sr=0;
    ...
    for(var i=0;i<re;i++){
     ...
     //   planamtdata=parseInt(planamtdata)+parseInt(planamt);
        if(paymenttype=='Cash'){
            totalcase=parseInt(totalcase)+parseInt(amt);
        }else{
            totalcheque=parseInt(totalcheque)+parseInt(amt);
        }
...
/*------------click Event Of Second Tab Next Button-----------*/
...
$(document).on("submit","#plannexpenses_form",function(e){
 ...
 // alert(paymenttype);
    ...
    $('#plannesexpenses_save_update').html('');
    ...
    '<td width="30%" id="expessubaccname_'+row_id+'">'+subaccountname+'</td>'+
    ...
    '<td><button  class="doc_edit_data2 btn btn-xs btn-primary"   id="'+row_id+'"  ><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button  class="plann_regional_delete_data2 btn btn-xs btn-danger"   id="'+row_id+'"  ><i class="fa fa-trash"></i></button>'+
    '</tr>';
    $("#expensive").append(markup);
}
...
$(document).on('click','.plann_regional_delete_data2',function(e){
    e.preventDefault();	
...
$(document).on("blur",".plannqty",function(e){
    e.preventDefault();
    var tamount=0;
    var plannqty=0;var plannrate=0;
   var plannqty= $('#plannqty').val();
   var plannrate=$('#plannrate').val();
