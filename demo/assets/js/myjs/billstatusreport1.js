        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<table id="myTable" class="table table-striped">' +
                    ...
                    '<th style="white-space:nowrap;text-align:left;padding:10px 10px;">Invoiced Amt.</th>' +
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html += ' </tr>' +
                        ...
                        '<td   id="supplierid_' + data[i].id + '">' + data[i].actualamount + '</td>' +
                        '<td id="projectname_' + data[i].id + '">' + invoiceamt + '</td>' +
                        '<td  id="expens_id_' + data[i].id + '">' + data[i].balanceamt + '</td>' +
                        ' </tr>';
